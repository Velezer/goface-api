...
func TestHandler_JWTRegister(t *testing.T) {
	...
	t.Run("Input Valid", func(t *testing.T) {
		...
		t.Run("Happy", func(t *testing.T) {
			if !testing.Short(){
				t.Skip("skipping unittest, this unittest already covered by integration test")
			}
...
func TestHandler_JWTLogin(t *testing.T) {
	...
	t.Run("Input valid", func(t *testing.T) {
		...
		t.Run("Happy", func(t *testing.T) {
			...
			mockBcrypt.On("CompareHashAndPassword", []byte(adminData.Password), []byte(adminData.Password)).Return(nil)
